...
* The original package name 'com.eaa.microservices.spring-cloud-config-server' is invalid and this project uses 'com.eaa.microservices.springcloudconfigserver' instead.
